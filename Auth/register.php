...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex">
                    <a href="./login.php" class="btn btn-outline-primary mx-3">Login</a>
    ...
    <main>
        <div class="container">
            <form action="../Admin/Auth/Register.php" method="POST" class="row g-3 needs-validation shadow my-5 p-5 rounded-3" novalidate>
                ...
                <div class="col-md-12">
                    ...
                    <input type="password" class="form-control" id="validationCustom03" name="CPass" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                </div>
